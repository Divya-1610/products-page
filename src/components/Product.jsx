    ...
    <div className='grid gap-3 sm:grid-cols-2 lg:grid-cols-4'>
      {
        ...
        <div className='bg-gray-200 text-center cursor-pointer'>
          <img src={product.image} className='mx-auto w-full'></img>
          <div className='p-4'>
          <h3 className='text-left line-clamp-2'>{product.description}</h3>
          <h3 className='text-2xl font-bold text-left'>₹{product.price}</h3>
          <h3 className='font-bold text-left'>{product.name}</h3>
          <h3 className='text-left'> {product.brand}</h3>
          </div>
        </div>
        )
      }
